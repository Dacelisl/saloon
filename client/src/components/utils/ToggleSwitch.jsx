...
const ToggleSwitch = ({ label, toggleState, handleToggleChange }) => {
  return (
    <>
      <span className='relative text-xs lg:text-base xxl:text-lg font-semibold text-gray-600'>{label}</span>
      <label htmlFor='toggle' className='relative flex items-center bg-stone-300 rounded-2xl h-6 w-full max-w-xs mt-1 mb-3'>
