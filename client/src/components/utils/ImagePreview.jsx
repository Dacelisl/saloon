...
const ImagePreview = ({ editable=false, setSelectedItem, imagenPreview, setImagenPreview, style='h-[130px]' }) => {
  ...
  return (
    <div className={`border p-4 pt-1 mx-auto mb-3 w-[80%] rounded-md bg-white  ${style}`}>
      <label htmlFor='uploadImage' className='block text-gray-300 text-sm font-bold cursor-pointer'>
