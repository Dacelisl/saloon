...
import { getTickets, getClients, updateClients } from '../../../firebase/firebase.js'
  ...
  return (
    <>
      <div className=' fixed inset-0 flex items-center top-[-5%] md:top-0 justify-center bg-secondary-dark backdrop-blur-xl  bg-opacity-75'>
        ...
        <div className='z-10 bg-primary-light  p-4 lg:w-fit  sm:w-[90%] mx-auto rounded-lg shadow-sm shadow-slate-700'>
          ...
          <div className='flex mt-2'>
            <ButtonDefault title='Abonar' onClick={openModal} />
          </div>
        </div>
      </div>
      <HistoricalClientCredit isOpen={isModalCreditOpen} onClose={handleCloseCreditModal}/>
    </>
  )
}
